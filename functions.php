...
function imageUpload($imageRequest)
{
  ...
  if (empty($msgError)) {
    move_uploaded_file($imagetmp, "upload/categories/". $imagename);
    return $imagename;
  } else {
    return "fail";
  }
...
{
    echo json_encode(array("status"=> "failuer", "messege"=> $messege));
}

function printSuccess($messege= 'none')
{
    echo json_encode(array("status"=> "success", "messege"=> $messege));
}
